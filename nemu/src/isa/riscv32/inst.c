...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = (int32_t)(SEXT((int64_t)src1, 32) * (uint64_t)src2 >> 32));
  ...
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(rd) = BITS(src1, 31, 31) << 31 | BITS((int32_t)src1 % (int32_t)src2, 30, 0));
